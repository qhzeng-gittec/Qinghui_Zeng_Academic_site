...
### [The Riccati Method for 3-D Helmholtz Equation](https://drive.google.com/file/d/1-64_bIOeH3vN1deOnDFdYVuF5J6dVYmc/view?usp=drive_link)&nbsp;&nbsp;&nbsp;&nbsp;(2024.5 – 2024.6)
In many applications, such as underwater acoustics and optics, wave propagation can be viewed as traveling primarily in the \(x\)-direction, with the transverse plane spanned by the \(y\)- and \(z\)-axes. For problems that can be simplified into two dimensions, such as waveguides that are homogeneous along one horizontal axis, Lu and McLaughlin proposed a Dirichlet-to-Neumann (DtN) based algorithm in 1995. This method solves the Riccati equation for the DtN operator \(Q\) and introduces the solution operator \(Y\), providing a more computationally efficient approach to wave propagation compared to finite difference or finite element methods.

In this work, I extend this DtN algorithm to three-dimensional waveguides, enabling it to handle more complex sources and waveguides. I derive the radiation condition specific to the 3D Helmholtz equation and propose a formulation based on matrix expansions under finite basis functions. This approach significantly reduces computational costs. Numerical examples and comparisons validate the accuracy of the proposed method across different scenarios.
